...
Current-evidence boundary: 273 Rust tests are discovered: 272 regular tests pass
...
```text
273 total Rust tests; 272 passed; 1 authenticated live Copilot test ignored by default
```
