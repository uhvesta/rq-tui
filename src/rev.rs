...
enum RevCommand {
    ...
    UiSnapshot {
        ...
        height: u16,
        /// review, split, markdown, github-review, github-description, expanded, files, panes, visual, questions, cleared-question, edit-feedback, question-models, model-search, resolve-confirm, resolved-history, stale-dismissed, command, composer, history, help, help-bottom, or streaming
