...
enum RevCommand {
    ...
    UiSnapshot {
        ...
        height: u16,
        /// review, split, expanded, files, panes, visual, questions, cleared-question, edit-feedback, question-models, command, composer, history, help, help-bottom, or streaming
